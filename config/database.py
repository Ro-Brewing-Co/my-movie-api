...
from sqalchemy.ext.declarative import declarative_base #Esto sirve para manipular todas las tablas de la base de datos

sqlite_file_name = "database.sqlite" #Aquí se guarda el nombre de la base de datos
